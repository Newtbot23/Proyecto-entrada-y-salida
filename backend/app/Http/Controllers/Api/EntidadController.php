...
class EntidadController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            $query = Entidades::with(['licencia', 'licencia.plan', 'admins']);
    ...
    {
        try {
            $entidad = Entidades::with(['licencia', 'licencia.plan', 'admins'])->find($nit);
     ...
     */
    public function update(UpdateEntidadRequest $request, string $nit)
    {
        try {
            ...
            // Recargar el modelo para obtener los datos actualizados con relaciones
            $entidad->load(['licencia', 'licencia.plan', 'admins']);
